...
if __name__ == '__main__':
    ...
    configuration = {
        ...
        "tensorboard_writer_path": "runs_2021_11_01",
        "section_message": "Type01-T01",
        "checkpoint_dir": "checkpoints/2021_11_01"
    ...
    configuration = {
        ...
        "input_dir": "dataset/v8/type01_train",
        "tensorboard_writer_path": "runs_2021_11_01",
        "section_message": "Type01-LeakyReLU-T06",
        "checkpoint_dir": "checkpoints/2021_11_01"
        # "checkpoint_path": "checkpoints/2021_09_16/quick_02-03_Custom_CRNN_AdamW_ReLU_0.001_sl15_999_epoch_1999.pt"
    }
    ...
    configuration = {
        ...
        "input_dir": "dataset/v8/type01_train",
        "tensorboard_writer_path": "runs_2021_11_01",
        "section_message": "Type01-LeakyReLU-T07",
        "checkpoint_dir": "checkpoints/2021_11_01"
        # "checkpoint_path": "checkpoints/2021_09_16/quick_02-03_Custom_CRNN_AdamW_ReLU_0.001_sl15_999_epoch_1999.pt"
    }
    ...
    configuration = {
        ...
        "num_workers": 8,
        "shuffle": True,
        "input_dir": "dataset/v8/type03_train",
        "tensorboard_writer_path": "runs_2021_11_01",
        "section_message": "Type03-PReLU-T90",
        "checkpoint_dir": "checkpoints/2021_11_01"
        # "checkpoint_path": "checkpoints/2021_09_16/quick_02-03_Custom_CRNN_AdamW_ReLU_0.001_sl15_999_epoch_1999.pt"
    }
    ...
    configuration = {
        ...
        # "input_dir": "dataset/v8/type01_train",
        "tensorboard_writer_path": "runs_2021_11_04",
        "section_message": "Type01-smallv8-adamw0.0005-T001+weak-SGD0.001",
        "checkpoint_dir": "checkpoints/2021_11_04",
